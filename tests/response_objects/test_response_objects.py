...
from harbor.request_objects import common as req


@pytest.fixture(name='response_value')
def fixture_response_value():
    return {'key': ['value1', 'value2']}


@pytest.fixture(name='response_type')
def fixture_response_type():
    return 'ResponseError'


@pytest.fixture(name='response_message')
def fixture_response_message():
